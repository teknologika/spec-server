...
from spec_server.models import Spec, Task, TaskStatus
from spec_server.task_executor import TaskExecutionContext, TaskExecutor
...
class TestTaskExecutor:
    ...
    def test_get_next_task_with_hierarchy(self):
        ...
        # Should return first sub-task, not paren
        next_task = executor.get_next_task(tasks)
        assert next_task is not None
...
# Integration test with real markdown conten
