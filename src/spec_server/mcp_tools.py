...
from .validation import (
    validate_create_spec_params, validate_update_spec_params,
    validate_read_spec_params, validate_task_params
)
...
class MCPTools:
    ...
    def __init__(self, base_path: Path = Path("specs")):
        ...
        Args:
            base_path: Base directory for storing specs
        """
    ...
    def list_specs(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise MCPToolsError(
                f"Failed to list specs: {str(e)}",
                error_code="LIST_SPECS_ERROR"
            )
